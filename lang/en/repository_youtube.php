...
$string['information'] = 'Enter the URL of your PeerTube instance (e.g., https://peertube.example.com) and your access token. The access token can be generated in your PeerTube account settings.';
...
$string['accesstoken_help'] = 'The access token for authenticating with the PeerTube API. You can generate this in your PeerTube account settings under "Applications" or "API".';
